<template>
  <div style="width: 100%;">
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="hot" label="是否置前"/>
    ...
    <el-dialog :title="dialogConfig.title" :visible.sync="dialogConfig.open" width="800px" append-to-body>
      <el-form ref="ruleForm" :model="form" :rules="form" class="demo-ruleForm" label-width="100px"
               label-position="left">
        <el-form-item label="标题:" prop="title">
          <el-input v-model="form.title" clearable></el-input>
        </el-form-item>
        <el-form-item label="摘要:" prop="abstracts">
          <el-input v-model="form.abstracts" clearable type="textarea"></el-input>
        </el-form-item>
        ...
        <el-form-item label="是否置前:" prop="hot">
